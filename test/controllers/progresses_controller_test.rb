...
class ProgressesControllerTest < ActionController::TestCase
  ...
  test "should create progress" do
    assert_difference('Progress.count') do
      post :create, progress: { call: @progress.call, closure: @progress.closure, plan: @progress.plan, preplan: @progress.preplan, tracking: @progress.tracking, users_id: @progress.users_id }
    end
  ...
  test "should update progress" do
    patch :update, id: @progress, progress: { call: @progress.call, closure: @progress.closure, plan: @progress.plan, preplan: @progress.preplan, tracking: @progress.tracking, users_id: @progress.users_id }
    assert_redirected_to progress_path(assigns(:progress))
  end
