...
class WorkshopsControllerTest < ActionController::TestCase
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post :create, workshop: { lenght: @workshop.lenght, source: @workshop.source, speaker: @workshop.speaker, title: @workshop.title }
    end
  ...
  test "should update workshop" do
    patch :update, id: @workshop, workshop: { lenght: @workshop.lenght, source: @workshop.source, speaker: @workshop.speaker, title: @workshop.title }
    assert_redirected_to workshop_path(assigns(:workshop))
  end
